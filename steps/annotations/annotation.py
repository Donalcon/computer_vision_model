...
def get_possession_background() -> PIL.Image.Image:
    ...
    counter = PIL.Image.open("steps/images/possession_board2.png").convert("RGBA")
...
def get_passes_background() -> PIL.Image.Image:
    ...
    counter = PIL.Image.open("steps/images/passes_board2.png").convert("RGBA")
    counter = add_alpha(counter, 210)
    counter = np.array(counter)
    red, green, blue, alpha = counter.T
    counter = np.array([blue, green, red, alpha])
...
def draw_possession_counter(
    ...
    frame = draw_counter(
        ...
        counter_text=match.home.get_time_possession(fps),
    ...
    frame = draw_counter(
        ...
        counter_text=match.away.get_time_possession(fps),
